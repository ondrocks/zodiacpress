...
Copyright 2016-2018 Isabel Castillo
...
final class ZodiacPress {
	...
	private function setup_constants() {
		if ( ! defined( 'ZODIACPRESS_VERSION' ) ) {
			define( 'ZODIACPRESS_VERSION', '1.8.3' );// @todo update
		}
	...
	private function includes() {
		...
		include_once ZODIACPRESS_PATH . 'includes/class-zp-report.php';
		...
		include_once ZODIACPRESS_PATH . 'includes/class-zp-custom-reports.php';
		...
		if ( is_admin() || ( defined( 'WP_CLI' ) && WP_CLI ) ) {
			...
			include_once ZODIACPRESS_PATH . 'includes/admin/custom-reports.php';
